...
gantt
    ...
    MachinesController cs 機器管理API 未作成 :active, TASK-079, 2025-12-12, 28d
    RentalsController cs 貸出管理API 未作成 :active, TASK-080, 2025-12-18, 28d
    UsersController cs ユーザー管理API 未作成 :active, TASK-081, 2025-12-24, 28d
    Machine cs 機器モデル 未作成 :active, TASK-082, 2025-12-30, 28d
    Rental cs 貸出モデル 未作成 :active, TASK-083, 2026-01-05, 28d
    フェーズ2 バックエンド開発完了 :milestone, M2, 2026-01-11, 1d

    section フェーズ3 フロントエンド開発
    LoginForm jsx ログインフォーム 未作成 :active, TASK-047, 2026-01-18, 21d
    MachineList jsx 機器一覧 未作成 :active, TASK-050, 2026-01-23, 21d
    MachineForm jsx 機器フォーム 未作成 :active, TASK-051, 2026-01-28, 21d
    MachineCard jsx スマホ用カード 未作成 :active, TASK-052, 2026-02-02, 21d
    RentalList jsx 貸出一覧 未作成 :active, TASK-053, 2026-02-07, 21d
    フェーズ3 フロントエンド開発完了 :milestone, M3, 2026-02-12, 1d

    section フェーズ4 機能実装
    ログイン機能 :active, TASK-106, 2026-02-19, 42d
    管理者権限判定 :active, TASK-107, 2026-02-28, 42d
    認証状態の永続化 Zustand persist :active, TASK-108, 2026-03-09, 42d
    認証ガード :active, TASK-109, 2026-03-18, 42d
    機器一覧表示 :active, TASK-110, 2026-03-27, 42d
...
gantt
    ...
    section 高優先度
    app main machines asset_no page jsx idから :active, TASK-028, 2025-11-30, 7d
    app main machines actions jsx Server Act :active, TASK-030, 2025-12-01, 7d
    app main rentals asset_no page jsx idからa :active, TASK-034, 2025-12-02, 7d
    app main rentals actions jsx Server Acti :active, TASK-037, 2025-12-03, 7d
    app main users employee_no page jsx idから :active, TASK-041, 2025-12-04, 7d
    app main users actions jsx Server Action :active, TASK-043, 2025-12-05, 7d
    app ThemeRegistry jsx MUIテーマ設定 component :active, TASK-046, 2025-12-06, 7d
    LoginForm jsx ログインフォーム 未作成 :active, TASK-047, 2025-12-07, 21d
    MachineList jsx 機器一覧 未作成 :active, TASK-050, 2025-12-08, 21d
    MachineForm jsx 機器フォーム 未作成 :active, TASK-051, 2025-12-09, 21d
